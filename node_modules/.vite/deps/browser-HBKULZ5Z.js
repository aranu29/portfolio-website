      ...
      _createClass(Collection3, [{
        ...
        value: function addIn(path, value) {
          if (isEmptyPath(path)) this.add(value);
            ...
            if (node instanceof Collection3) node.addIn(rest, value);
        ...
        value: function deleteIn(_ref) {
          ...
          var node = this.get(key, true);
          if (node instanceof Collection3) return node.deleteIn(rest);
          else throw new Error("Expected YAML collection at ".concat(key, ". Remaining path: ").concat(rest));
        }
      }, {
        key: "getIn",
        value: function getIn(_ref3, keepScalar) {
          ...
          else return node instanceof Collection3 ? node.getIn(rest, keepScalar) : void 0;
        }
      }, {
        ...
        value: function setIn(_ref7, value) {
          ...
          if (rest.length === 0) {
            ...
            var node = this.get(key, true);
            if (node instanceof Collection3) node.setIn(rest, value);
            else if (node === void 0 && this.schema) this.set(key, collectionFromPath(this.schema, rest, value));
            else throw new Error("Expected YAML collection at ".concat(key, ". Remaining path: ").concat(rest));
          }
        }
...
function assertCollection(contents) {
  if (contents instanceof Collection2) return true;
...
//# sourceMappingURL=browser-HBKULZ5Z.js.map
